...
function buildFilm(m){
  ...
  t.to(kEyebrow, { opacity: 1, y: 0, duration: 0.45, ease: 'power3.out' }, 1.54)
   ...
   .to(line3Chars, { yPercent: 0, rotationX: 0, duration: 0.55, ease: 'power3.out', stagger: 0.033 }, 2.26)
   .to(uline, { drawn: 1, duration: 0.45, ease: 'power2.inOut' }, 2.74)
   .to(kSub, { opacity: 1, y: 0, duration: 0.45, ease: 'power3.out' }, 2.94);
...
memoriesBtn.addEventListener('click', () => {
  ...
  if (!emojisCreated) {
    ...
    for (let i = 0; i < 40; i++) {
      ...
      el.style.animationDuration = (Math.random() * 3 + 4) + 's'; // 4s to 7s
      el.style.animationDelay = Math.random() * 5 + 's';
      el.style.fontSize = (Math.random() * 14 + 16) + 'px'; // 16px to 30px
...
/* ============================================================
   ...
   ============================================================ */
const LOVE_LINES = [
  'Your laughter is contagious ✨', 'Thank you for always being there for me 💖',
  'You make the world a brighter place 🌟', 'I cherish every memory we share 💕',
  'Here is to many more adventures together 🥂', 'You are an absolutely amazing friend 🥰',
];
let loveNoteTimer = 0;
...
/* ============================================================
   ...
   ============================================================ */
const COMPLIMENTS = [
  'You are fiercely independent and strong.', 'Your creativity never ceases to amaze me.', 'You have a wonderful sense of humor.',
  'You are incredibly thoughtful and caring.', 'Your positive energy is unmatched.', 'You are beautiful inside and out.',
];
...
/* ============================================================
   ...
   ============================================================ */
const LETTER_TEXT = "Dear Niranjana, wishing you the happiest of birthdays! I'm so grateful to have a friend as amazing, kind, and beautiful as you. May your special day be filled with all the joy and love you deserve. Here's to another year of wonderful memories. Happy birthday!";
